  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <h3 className="footer--title">Bidheesh V C</h3>
        </div>
      ...
      <div className="footer--content--container">
        <p className="footer--content"> 2024 Bidheesh V C - MERN Stack Developer</p>
      </div>
    </footer>
  );
}
